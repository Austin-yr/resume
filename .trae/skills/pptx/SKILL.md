---
name: "pptx"
description: "Handles PowerPoint presentations - reads, analyzes, edits, and creates presentations. Invoke when user needs to work with PPTX files, analyze content, or create presentations."
---
...
```bash
python -m markitdown output.ppt
```